                    ...
                    <div class="preview">
                        <form action="{{ route('store.post') }}" method="POST">
                            ...
                            <div class="input-form">
                                ...
                                <input type="text" name="title" class="input w-full border mt-2" minlength="2" required>
                            </div>
                            <div class="input-form mt-3">
                                ...
                                <textarea class="input w-full border mt-2" name="body" placeholder="Type your body" minlength="10" required></textarea>
                            </div>
